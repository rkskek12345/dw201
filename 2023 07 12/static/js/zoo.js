window.onload=function(){
    ...
    pre.addEventListener("click", function(){
        var slideviwe =document.getElementsByClassName("eventslide")[0];
        slideviwe.style.transform="translate3d(0px, 0px, 0px)";
    ...
    next.addEventListener("click", function(){
        var slideviwe =document.getElementsByClassName("eventslide")[0];
        slideviwe.style.transform="translate3d(-936px, 0px, 0px)";
